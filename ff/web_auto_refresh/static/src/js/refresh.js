odoo.define("app_auto_refresh.auto_refresh", function(require) {
  "use strict";
    ...
    handler_msg: function(msg) {
      if (msg == "refresh") {
        try {
          ...
          var controller = this.action_manager.inner_widget.active_view
            .controller;
          // if (controller.mode === "readonly") {
